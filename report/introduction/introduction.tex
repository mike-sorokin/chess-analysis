...
pre-existing work is covered. 

Chapter \ref{implementationChapter} covers the ideas and implementations of the
two distinct approaches that this project explores: a transformer-based deep
learning approach in Section \ref{transformersSection} and a tree
comparison-based distance appraoch in Section \ref{treesSection}.
