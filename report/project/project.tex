\chapter{The Machine Learning Approach}\label{mlChapter}
...
\subsection{Representing Puzzles With Labelled Trees}
...
checked and are indeed knight forks.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.475\textwidth}
        ...
        \caption{Fork cluster puzzle. White wins a bishop after \texttt{1.Nxe5+}}
        \label{hCl2}
    \end{minipage}
\end{figure}
