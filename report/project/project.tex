...
highlighted rows can be seen in Section \ref{tsneVis}.
...
\begin{table}[H]
  ...
  \begin{tabular}{lr|rccccrrrrrrr}
    ...
    \rowcolor{lightgray} single&500&7196&Y&Y&Y&Y&0&2.78&1&1&1&1&10057\\
...
\begin{table}[H]
  ...
  \rowcolor{lightgray} 500&7&6&Y&Y&Y&Y&35.89&2137.33&7&86&346&1630&10067\\
...
\ref{tabHDBSCAN}), and drops to about 35\% for DBSCAN (Table \ref{tabDBSCAN}).
Unfortunately, the lowest percentage happens when DBSCAN identifies 6 clusters,
which is far too few to draw meaningful conclusions from.

\subsection{Visualisations of Puzzle Clusters}\label{tsneVis}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.475\textwidth}
        \centering
        \chessboard[setfen= r3k2r/pp1qbppp/2pp1n2/8/3QP3/2N2P1P/PPP2P2/R1B3RK b kq - 4 13]
        \caption{Same cluster as Figure \ref{chess11}. Solution: \texttt{1...Qxh3\#}}
